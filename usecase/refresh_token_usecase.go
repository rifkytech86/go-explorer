...
func (rtu *refreshTokenUsecase) ExtractFromToken(requestToken string, secret string) (string, string, error) {
	return tokenutil.ExtractFromToken(requestToken, secret)
}
